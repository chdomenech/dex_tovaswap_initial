import { ChainId, Currency, currencyEquals, JSBI, Price } from '@tovaswapsdk/sdk'
...
export const useCakeBusdPriceBigNumber = (): BigNumber | undefined => {
  const cakeBusdPrice = useBUSDPrice(tokens.cake)
  if(cakeBusdPrice === undefined) {
    return new BigNumber("0");
  }else{
    return new BigNumber(cakeBusdPrice.toFixed());
  }  
}
