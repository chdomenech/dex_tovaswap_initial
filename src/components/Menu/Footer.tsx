      ...
      >
        <BubbleWrapper>
          <Button
            ...
            as="a"
            external
            href="https://info.tovaswap.com/products/tovaswap-exchange"
            variant="subtle"
          >
            {t('Need help ?')}
          </Button>
        ...
        <Image src="/images/decorations/phishing-warning-bunny2.webp" alt="Get some help" width={150} height={198} />
      </Flex>
    </Wrapper>
  )
}
