...
import { Image, Heading, RowType, Toggle, Text, Button, ArrowForwardIcon, Flex } from '@tovaswapui/uikit'
import { NextLinkFromReactRouter } from 'components/NextLink'
import { ChainId } from '@tovaswapsdk/sdk'
  ...
  return (
    <FarmsContext.Provider value={{ chosenFarmsMemoized }}>
      ...
      <Page>
        ...
        <div ref={observerRef} />
        <StyledImage src="/images/decorations/3dpan.png" alt="illustration" width={120} height={103} />
      </Page>
