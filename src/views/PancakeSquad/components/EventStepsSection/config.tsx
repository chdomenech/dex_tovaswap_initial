  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active TovaSwap Profile to buy Minting Tickets!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold TVS'),
      bodyText: [t('Each NFT costs TVS to mint. Remember you also need BNB to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
