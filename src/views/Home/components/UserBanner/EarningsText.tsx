...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and TVS pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and TVS pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from TVS pool', data)
  }
